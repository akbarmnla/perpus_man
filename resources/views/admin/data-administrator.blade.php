...
@section('script')
    <script>
        Alpine.data("data", () => ({
            ...
            init() {
                ...
                fetch("http://localhost:3030/members", {
                    ...
                    for (let x of res.data)
                        if (x.role == 'admin') this.members.push(x)
                })
            },
            deletes(data) {
                let token = localStorage.getItem("token")
            ...
            edit(data) {
                location.href = `/update-administrator/${data._id}`
            }
        }))
    </script>
@endsection
    ...
    <div class="container">
        <div class="card">
            ...
            <div class="d-grid gap-2 d-md-block" style="margin-left:20px">
                <a class="btn btn-outline-light" href="/tambah-administrator"
                    role="button"style="background-color: #000851">Tambah Administrator</a>
                <div class="card-body">
                    <table class="table">
                        <thead>
                            <th>No</th>
